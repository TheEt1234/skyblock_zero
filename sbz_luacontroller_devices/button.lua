core.register_node('sbz_luacontroller_devices:button', {
...
sbz_api.register_stateful('sbz_luacontroller_devices:toggle', {
...
unified_inventory.register_craft {
    ...
    output = 'sbz_luacontroller_devices:button 4',
    width = 2,
    height = 2,
}
...
unified_inventory.register_craft {
    ...
    output = 'sbz_luacontroller_devices:toggle 4',
    width = 2,
    height = 2,
}
