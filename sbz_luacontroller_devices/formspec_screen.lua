local max = 100 * 1024
core.register_node('sbz_luacontroller_devices:formspec_screen', {
    ...
    on_logic_send = function(pos, msg, from_pos)
        ...
        elseif msg == 'unsubscribe' then
            ...
            core.get_meta(pos):set_string('formspec', msg)
        end
    end,
    on_receive_fields = function(pos, formname, fields, sender)
        local send_to_pos = vector.from_string(core.get_meta(pos):get_string('linked') or '')
...
do -- Formspec Screen recipe scope
    local Formspec_Screen = 'sbz_luacontroller_devices:formspec_screen'
