...
core.register_node('sbz_luacontroller_devices:memcontroller', {
    ...
    on_logic_send = function(pos, msg, from_pos)
        ...
        if type(msg.key) == 'string' and #msg.key <= key_size_limit then
            ...
            elseif msg.type == 'set' or msg.type == 'setc' then
                ...
                local old_size = 0
                if entry then old_size = entry.size end

                if should_compress then value = compress(value) end
...
unified_inventory.register_craft {
    ...
    output = 'sbz_luacontroller_devices:memcontroller',
    width = 2,
    height = 1,
}
